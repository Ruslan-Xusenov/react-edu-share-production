...
if not SECRET_KEY:
    if not DEBUG:
        raise ValueError(
            "XATO: SECRET_KEY .env faylda o'rnatilishi shart! "
            "Production rejimda default SECRET_KEY ishlatilmaydi."
        )
    SECRET_KEY = 'django-insecure-default-FAQAT-DEVELOPMENT-UCHUN'
...
MIDDLEWARE = [
    ...
    # ✅ SEO: Dynamic Rendering — Google/Yandex botlari uchun to'liq HTML
    'core.bot_renderer.BotRenderMiddleware',
]
...
elif os.getenv('DATABASE_NAME') and os.getenv('DATABASE_USER'):
    DATABASES = {
        'default': {
...
# Cache Configuration — Production da Redis, Development da LocMemCache
...
FRONTEND_URL = os.getenv('FRONTEND_URL', 'https://edushare.uz')
...
if not DEBUG:
    ...
    # Secure Proxy Header for Heroku/Nginx
    ...
    'extends': {
        ...
        'table': {
            ...
            'formatBlocks': [
                ...
                {
                    'name': 'H1',
                    'class': 'document-heading-1',
                    'title': 'Heading 1'
                },
                {
                    'name': 'H2',
                    'class': 'document-heading-2',
                    'title': 'Heading 2'
                },
                {
                    'name': 'H3',
                    'class': 'document-heading-3',
                    'title': 'Heading 3'
                }
            ]
        },
